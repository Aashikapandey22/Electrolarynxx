  ...
  return (
    <div className="min-h-screen bg-[#020617] text-[#F8FAFC]">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-20 pb-8 text-center">
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }} className="text-xs uppercase tracking-[0.4em] text-[#38BDF8] mb-4">GraphineLabs Smart Electrolarynx</motion.p>
      ...
      <div className="max-w-2xl mx-auto px-6 pb-20">
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex items-baseline justify-between mb-2">
            <span className="text-slate-400 text-sm">GraphineLabs Smart Electrolarynx × {quantity}</span>
      ...
      <section id="features" className="max-w-5xl mx-auto px-6 py-20 border-t border-slate-800/50">
        <h2 className="text-3xl md:text-4xl font-light text-center mb-16">Why GraphineLabs</h2>
      ...
      <footer className="border-t border-slate-800/50 py-8 px-6 text-center text-xs text-slate-600">
        <p>GraphineLabs © 2026. All rights reserved.</p>
      </footer>
    </div>
  );
}
